...
<head>
    ...
    <title>under-tour section</title>
</head>
<body>
<!-- top header section -->
<header>
...
<div class="container-fluid text-center p-5" style="background-color: antiquewhite;">
    <div class="row">
        
        <h2 class="fw-bold text-danger" >Heli Tour</h2>
        <p class="fw-bold">Enjoy the thrills of paragliding over spectacular landscapes taking unbelievable views of the Himalayan mountains, pristine lakes, and verdant valleys like nowhere else on earth. Nothing can beat the thrill of being up in the sky, flying like a bird in the thermals all the while enjoying views of snow-capped mountains, pristine lakes, and verdant valleys like nowwhere else on earth. With experienced pilots to guid you through the skies, it's an experience of a lifetime. You may fly again someday, but you'll never enjoy the same spectacular views. Choose from tandem flights to fully certified paragliding courses, solo flights, or eveb gi oaragliding accompanied by hawks!</p>    
</div>
</div>
<!-- 2nd part -->
<div class="container my-4">
<div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow h-md-250 w-75 position-relative">
        
<div class="col-auto d-none d-lg-block">
        <img src="img/car/h1.jpg" class="bd-placeholder-img" width="200" height="250"  alt="">

        </div>

<div class="col p-4 d-flex flex-row position-static">
          
<div class="one">
<h3 class="fw-bold ">Langtang Heli Tour </h3><br>
         <p class="text-primary fw-bold">Duration : <i class="fa-regular fa-clock text-primary"></i> <span class="text-dark ms-1 text-mute"> 1 Day</span></p>
</div>
          
         <p class="text-light ms-5">gjdkffgjr;dlkhfglhkjsklfjiojio</p>
          
         <div class="two">
            <small>from</small>
<h3 class="fw-bold text-dark">$ 2,000</h3>
         <br>
         <button type="button" class="btn btn-primary text-light">VIEW DETAILS</button>
         </div>
        </div>
...
<div class="col-auto d-none d-lg-block">
        <img src="img/car/h2.jpg" class="bd-placeholder-img" width="200" height="250"  alt="">
...
<div class="one">
<h3 class="fw-bold ">Annapurna Heli Tour</h3><br>
         <p class="text-primary fw-bold">Duration : <i class="fa-regular fa-clock text-primary"></i> <span class="text-dark ms-1 text-mute"> 1 Hour</span></p>
</div>
...
<div class="col-auto d-none d-lg-block">
        <img src="img/car/h3.jpg" class="bd-placeholder-img" width="200" height="250"  alt="">
...
<div class="one">
<h3 class="fw-bold ">Everest Helicopter Tour </h3><br>
         <p class="text-primary fw-bold">Duration : <i class="fa-regular fa-clock text-primary"></i> <span class="text-dark ms-1 text-mute"> 1 Day</span></p>
</div>
